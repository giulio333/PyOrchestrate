...
- [AgentLifecycleManager](/advanced/orchestrator-internals/lifecycle-manager) - Creates agents in dependency order
- [WorkerPoolScheduler](/advanced/orchestrator-internals/worker-pool) - Manages concurrent execution
