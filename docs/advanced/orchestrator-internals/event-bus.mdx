...
- [MessageRouter](/advanced/orchestrator-internals/message-router) - Routes agent messages to EventBus
- [EventManager](/advanced/utilities/event-manager) - Low-level callback system
