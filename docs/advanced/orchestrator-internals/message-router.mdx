...
- [OrchestratorEventBus](/advanced/orchestrator-internals/event-bus) - Receives translated events
- [MessageChannel](/advanced/utilities/message-channel) - Low-level message transport
- [AgentLifecycleManager](/advanced/orchestrator-internals/lifecycle-manager) - Creates agents with MessageChannel
