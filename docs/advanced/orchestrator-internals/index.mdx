...
### 1. [DependencyGraph](/advanced/orchestrator-internals/dependency-graph)
...
### 2. [AgentLifecycleManager](/advanced/orchestrator-internals/lifecycle-manager)
...
### 3. [WorkerPoolScheduler](/advanced/orchestrator-internals/worker-pool)
...
### 4. [OrchestratorEventBus](/advanced/orchestrator-internals/event-bus)
...
### 5. [MessageRouter](/advanced/orchestrator-internals/message-router)
...
### 6. [CommandInterface](/advanced/orchestrator-internals/command-interface)
...
|---------|---------|---------|
| [EventManager](/advanced/utilities/event-manager) | OrchestratorEventBus | Callback execution |
| [PluginManager](/advanced/utilities/plugin-manager) | AgentLifecycleManager | Plugin lifecycle |
| [MessageChannel](/advanced/utilities/message-channel) | MessageRouter, CommandInterface | Inter-process communication |

These utilities are documented separately in the [Utilities](/advanced/utilities/index) section.
...
- [Introduction to Orchestrator](/learn/introduction/orchestrator/index) - High-level usage guide
- [Core Utilities](/advanced/utilities/index) - Low-level building blocks
- [CLI Reference](/cli/index) - Command-line tools
