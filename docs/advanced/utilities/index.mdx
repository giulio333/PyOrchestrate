...
These utilities are **building blocks** used by the framework's higher-level components. If you're learning about orchestrator internals, see the [Orchestrator Internals](/advanced/orchestrator-internals/index) section to understand how these utilities are composed into specialized managers.
</Tip>
...
|---------|---------|---------|
| **[EventManager](/advanced/utilities/event-manager)** | Callback-based event system | OrchestratorEventBus |
| **[PluginManager](/advanced/utilities/plugin-manager)** | Plugin lifecycle management | AgentLifecycleManager, Agents |
| **[MessageChannel](/advanced/utilities/message-channel)** | Inter-process communication | MessageRouter, CommandInterface |
...
### [Plugin Manager](/advanced/utilities/plugin-manager)  
...
**Used By**: AgentLifecycleManager (for agent plugin management), BaseAgent, Orchestrator

### [Message Channel](/advanced/utilities/message-channel)
...
- [Orchestrator Internals](/advanced/orchestrator-internals/index) - How managers use utilities
- [Agent Architecture](/learn/agents/index) - How agents use utilities

## Learning Path

### For Application Developers

1. Start with **[Introduction](/learn/introduction/index)** - Understand orchestrators and agents
...
1. Read **[Orchestrator Internals](/advanced/orchestrator-internals/index)** - Understand manager architecture
2. Study **Core Utilities** (this section) - Low-level building blocks
3. Review source code - Implementation details

## See Also

- [Orchestrator Internals](/advanced/orchestrator-internals/index) - High-level manager architecture
- [Configuration and Validation](/learn/config_and_validation) - Configuration management
- [Advanced Architecture](/advanced/index) - Deep architectural topics
