...
To learn more about control events, click [here](/learn/agents/index#controlevents).
...
| Attribute | Description |
|-----------|-------------|
| start_event | Event set after the agent's `run()` method begins. |
| ready_event | Event to signal that the agent is ready to start. |
| close_event | Event to signal that the agent is closing. |

To learn more about state events, click [here](/learn/agents/index#stateevents).
