...
<img src="/learn/introduction/agents/types_l.svg" alt="alt text" className="block dark:hidden" />
<img src="/learn/introduction/agents/types_d.svg" alt="alt text" className="hidden dark:block" />
