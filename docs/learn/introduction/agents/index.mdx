...
Agents come in four shapes, depending on their intended behaviour:

- **BaseAgent**: performs a single task and then exits.
- **LoopingAgent**: continuously performs a task until externally stopped.
- **PeriodicAgent**: executes at regular time intervals.
- **PoolAgent**: distributes work over a pool of child agents it supervises.

The last three build on the lifecycle and configuration support of `BaseAgent`, and each of the four exists in a **process** and a **thread** flavour — `LoopingProcessAgent` and `LoopingThreadAgent`, and so on. Reacting to external events is what the [communication plugins](/learn/agents/plugins/communication-plugins) are for, on any of them.

<Tip>
To learn more about the different Agent types, check out the [Hierarchical Structure](/learn/agents/index#hierarchical-structure) section.
</Tip>
...
<Tip title="Example">
See the [LoopingAgent Config](/learn/agents/built-in-agents/loopingagent#configuration) for more details.
</Tip>
...
<img src="/learn/introduction/agents/lifecycle_l.svg" alt="alt text" className="block dark:hidden" />
<img src="/learn/introduction/agents/lifecycle_d.svg" alt="alt text" className="hidden dark:block" />
...
<img src="/learn/introduction/agents/events_l.svg" alt="alt text" className="block dark:hidden" />
<img src="/learn/introduction/agents/events_d.svg" alt="alt text" className="hidden dark:block" />
...
<Tip>
To learn more about the different events, check out the [Agent State Events](/learn/agents/index#stateevents) section.
</Tip>
...
<Tip>
To learn more about the different events, check out the [Agent Control Events](/learn/agents/index#controlevents) section.
</Tip>
...
<Tip>
To learn more about the different validation policies, check out the [Validation](/learn/config_and_validation#validation) section.
</Tip>
