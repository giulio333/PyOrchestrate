...
I processi **OneShotSlave** e **LoopingSlave** derivano da uno **SlaveProcess**. E' una buona scelta utilizzare questa
classe per definire il vostro processo slave se avete bisogno di un comportamento personalizzato.
